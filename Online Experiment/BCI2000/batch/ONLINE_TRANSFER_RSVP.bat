...
Start executable Biosemi2 --local
##Start executable SignalGenerator --local
Start executable MatlabSignalProcessing --MatlabWD="./matlab_RSVP" --local
##Start executable DummySignalProcessing --local
Start executable StimulusPresentation --local
Wait for Connected
Load parameterfile "../parms/TransferExperiment/ONLINE_TRANSFER_RSVPv2.prm"
